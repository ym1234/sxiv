 ...
 */
static const char * const BAR_FONT = "curie:size=8";

/* colors:
 * (see X(7) section "COLOR NAMES" for valid values)
 */
static const char * const WIN_BG_COLOR = "#1D1F21";
static const char * const WIN_FS_COLOR = "#1D1F21";
static const char * const SEL_COLOR    = "#A54242";
static const char * const BAR_BG_COLOR = "#A54242";
